...
class ComentariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentary" do
    assert_difference("Comentary.count") do
      post comentaries_url, params: { comentary: { description: @comentary.description, photos_id: @comentary.photos_id, user_id: @comentary.user_id } }
    end
  ...
  test "should update comentary" do
    patch comentary_url(@comentary), params: { comentary: { description: @comentary.description, photos_id: @comentary.photos_id, user_id: @comentary.user_id } }
